 ...
 * further details.
 */
public interface PersonRepository extends PagingAndSortingRepository<PersonEntity, Integer>, PersonRepositoryCustom {

    PersonEntity findOneByEmailAddress(String emailAddress);
}
