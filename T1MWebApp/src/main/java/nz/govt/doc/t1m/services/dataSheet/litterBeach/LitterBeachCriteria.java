 ...
 */
public class LitterBeachCriteria extends AbstractCriteria {

    private String litterBeachCriteria;

    public LitterBeachCriteria() {
        super();
    }

    public String getLitterBeachCriteria() {
        return litterBeachCriteria;
    }

    public void setLitterBeachCriteria(String litterBeachCriteria) {
        this.litterBeachCriteria = litterBeachCriteria;
    }
