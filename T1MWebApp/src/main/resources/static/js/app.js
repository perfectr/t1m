...
//  $routeProvider.when('/person/edit/:personId', {templateUrl: '/partials/PersonEdit.html',    controller: 'PersonEditCtrl'});
  ...
  $routeProvider.when('/birdCount/edit/:dataSheetId',       {templateUrl: '/partials/BirdCountEdit.html',                   controller: 'BirdCountEditCtrl'});
  $routeProvider.when('/bcBird/search',                     {templateUrl: '/partials/BCBirdSearch.html',                    controller: 'BCBirdSearchCtrl'});
  $routeProvider.when('/bcBird/edit/:instanceId',           {templateUrl: '/partials/BCBirdEdit.html',                      controller: 'BCBirdEditCtrl'});
...
//  $routeProvider.when('/incidentalBird/search',             {templateUrl: '/partials/IncidentalBirdSearch.html',            controller: 'IncidentalBirdSearchCtrl'});
  ...
  $routeProvider.when('/litterBeach/edit/:dataSheetId',     {templateUrl: '/partials/LitterBeachEdit.html',                 controller: 'LitterBeachEditCtrl'});
  $routeProvider.when('/lbItem/search',                     {templateUrl: '/partials/LBItemSearch.html',                    controller: 'LBItemSearchCtrl'});
  $routeProvider.when('/lbItem/edit/:instanceId',           {templateUrl: '/partials/LBItemEdit.html',                      controller: 'LBItemEditCtrl'});
